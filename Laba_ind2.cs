...
Ellipsoid figure2 = new Ellipsoid("Вторая фигура",8,4,4);
...
Ellipsoid bigfigure = new Ellipsoid("новая фигура", figures[figures.Length - 1].a * 2, figures[figures.Length - 1].b * 2, figures[figures.Length - 1].c * 2);
